...
const ChatPage = () => {
    ...
    const handleTyping = () => {
        socket.emit('typing', {
            ...
            isTyping: textMessage.length > 4, // true if there is text in the input
        });
    };

    const sendMessageHandler = async (receiverId) => {
        try {
            const res = await axios.post(`https://learnietaskdivamsanghvi.onrender.com/api/v1/message/send/${receiverId}`, { textMessage }, {
                headers: {
